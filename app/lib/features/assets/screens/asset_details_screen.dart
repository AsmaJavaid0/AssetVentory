...
class _AssetDetailsScreenState extends State<AssetDetailsScreen> {
  ...
  Future<List<LocalAssetDocument>> _loadDocuments() {
    return serviceLocator.assetDocumentRepository.getDocuments(_asset.id);
  }
  ...
  Widget _buildPhoto() {
    return ClipRRect(
      ...
      child: AspectRatio(
        aspectRatio: 16 / 8,
        child: _asset.imagePath != null && _asset.imagePath!.isNotEmpty
            ? Image.file(
                File(_asset.imagePath!),
                fit: BoxFit.cover,
  ...
  Widget _buildInfoCard() {
    return Container(
      ...
      child: Column(
        children: [
          _infoRow('Category', _asset.categoryId == null ? 'Uncategorized' : _categoryName()),
          _divider(),
