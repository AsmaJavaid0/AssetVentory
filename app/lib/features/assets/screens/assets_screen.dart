...
class _AssetsScreenState extends State<AssetsScreen>
  ...
  int _countFor(String categoryId) {
    return _assets.where((asset) => asset.categoryId == categoryId).length;
  }
  ...
  Future<void> _addCategory() async {
    ...
    await _load();
    if (!mounted || createdCategoryId == null || createdCategoryId!.isEmpty) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(
          categoriesMode ? 'Add Category' : 'Add Asset',
      ...
      body: Column(
        children: [
          ...
          _tabs(),
          Expanded(
            child: categoriesMode ? _categoriesView() : _assetsView(),
          ),
        ],
      ),
    );
      ...
      child: Row(
        children: [
          ...
          PopupMenuButton<_AssetSort>(
            ...
            itemBuilder: (_) => const [
              PopupMenuItem(
                value: _AssetSort.newest,
                child: Text('Newest first'),
              ),
              PopupMenuItem(
                value: _AssetSort.name,
                child: Text('Name A–Z'),
              ),
              PopupMenuItem(
                value: _AssetSort.location,
          ...
          child: assets.isEmpty
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, index) => _assetCard(assets[index]),
                  ),
                ),
        ),
      ],
  ...
  Widget _assetCard(LocalAsset asset) {
    final categoryName = asset.categoryId == null
        ? 'No category'
        : _categories
                .where((category) => category.id == asset.categoryId)
  ...
  Widget _assetEmoji(LocalAsset asset) {
    return Center(
      child: Text(
        asset.emoji ?? '📦',
      ...
      return RefreshIndicator(
        ...
        child: ListView(
          children: [
            ...
            Center(
              child: Text(
                'Use Add Category below to create one.',
