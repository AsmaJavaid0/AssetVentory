...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  Widget _buildCurrentPage() {
    switch (_currentIndex) {
      case 0:
        return HomeScreen(onTabSelected: (index) => setState(() => _currentIndex = index));
      case 1:
      ...
      case 4:
        return ProfileScreen(onNavigateTab: (index) => setState(() => _currentIndex = index));
      default:
        ...
        child: SafeArea(
          child: BottomNavigationBar(
            ...
            items: const [
              ...
              BottomNavigationBarItem(icon: Icon(Icons.inventory_2_outlined), activeIcon: Icon(Icons.inventory_2_rounded), label: 'Assets'),
              BottomNavigationBarItem(icon: Icon(Icons.group_outlined), activeIcon: Icon(Icons.group_rounded), label: 'Family'),
              BottomNavigationBarItem(icon: Icon(Icons.task_alt_outlined), activeIcon: Icon(Icons.task_alt_rounded), label: 'Tasks'),
