  ...
  Future<void> _removePin() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Shared assets will no longer require the family PIN.',
        ),
        actions: [
          TextButton(
                    ...
                    children: [
                      ...
                      Text(
                        _unlockOnly
                            ...
                            : 'Protect your family\'s shared assets with a separate 4–6 digit PIN. The PIN is stored securely as a salted hash.',
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: _unlockOnly ? 'Family PIN' : 'New PIN',
                      ...
                      SizedBox(
                        ...
                        height: 52,
                        child: FilledButton(
                          onPressed: _unlockOnly ? _verify : _savePin,
                          ...
                          child: Text(
                            _unlockOnly
                                ...
                                : (enabled ? 'Update PIN' : 'Enable PIN'),
                          ),
                        ),
                      ),
                      if (!_unlockOnly && enabled && _isOwner) ...[
                        const SizedBox(height: 10),
                        TextButton.icon(
